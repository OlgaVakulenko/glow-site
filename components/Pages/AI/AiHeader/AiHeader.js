  ...
  const runAnimationCycle = useCallback(() => {
    if (screenSize && screenSize in layersCount) {
      ...
      requestAnimationFrame(() => {
        ...
        animationFrameRef.current = setTimeout(runAnimationCycle, duration + animationDelay);
      });
    }
  }, [screenSize]);
    ...
    <section className='ai-background pt-[88px] pb-[56px] md:py-[72px] xl:pt-0 xl:mt-[88px] xl:pb-[88px] 2xl:pt-0'>
      <Layout>
        <div className="xl:w-3/4 md:w-3/4 mx-auto xl:mt-0 xl:mb-[135px] md:mt-[135px] md:mb-[135px] mt-[52px] mb-0 flex flex-col items-center z-[6]">
					<div className='relative w-full justify-center align-bottom flex xl:pt-[22px]'>
            <div className='ai-button-icon-left h-[167px] w-[288px] hidden xl:block'>
            ...
            <div className='ai-button-icon-right h-[167px] w-[293px] hidden xl:block'>
