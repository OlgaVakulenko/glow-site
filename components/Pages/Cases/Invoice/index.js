  ...
  return (
    <div>
      ...
      <Layout className="grid gap-4 md:grid-cols-8 md:gap-8 xl:grid-cols-12">
        <Animated className="relative overflow-hidden rounded-[24px] rounded-t-[44px] md:col-span-8 md:rounded-[44px] md:rounded-b-[32px] xl:col-span-12 xl:rounded-[56px] xl:rounded-t-[56px]">
          <RespImage
            pictureClassname=""
            className=""
            src={Frame2}
