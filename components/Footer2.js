      ...
      {isSubmitted ? (
        ...
        showForm && (
          <Layout disableOnMobile={true} className="px-2">
            <div className={cx("text-inter relative overflow-hidden rounded-3xl px-6 py-[138px] md:rounded-[32px] md:py-[134px] xl:py-[142px] xl:pb-[124px] xl:pt-[128px]", {'dark-outline footer-dark': dark})}>
              <Image
