...
export default function Content({ html, paragraphs }) {
  ...
  return (
    <article
      ref={ref}
      className={cx(
        'prose prose-headings:mb-6 prose-headings:mt-[60px] prose-headings:font-satoshi prose-headings:text-next-heading-6 prose-headings:font-medium md:prose-headings:text-[32px] md:prose-headings:leading-[37px] xl:prose-headings:text-next-heading-5',
