...
const items = [
  {
    ...
    a: `We stand for bringing complex solutions in simple and comprehensible forms. Turn complex
    digital systems into clean and usable products.
    We care for consistent user flow from the first demo to full-scale Omni channel operations.
    We ensure that for the user the first experience pays off and the last never comes.
  ...
  },
  {
    ...
    a: `We provide the estimate after the discovery call with the client (You can book a call right
      now).
      Our pricing model is a flat rate per hour. The rate itself depends on the amount of work, time
      estimate, and number of required specialists. 90% of our projects start with a proper
      estimation process that result in a clear cost structure and a timeframe.`,
  },
  {
    q: `Team allocation.`,
    a: `Team size may vary due to the scale of the project. Nevertheless, we always provide our
    customers with a product designer, a lead designer, and a project manager.`,
  },
  {
    q: `How does our cooperation start?`,
    a: `We start with an intro call. After the call and review of all shared materials, we create a
    project estimation with determined time range, cost, and team size.`,
  },
  {
    q: `What about edits and iterations revision?`,
    a: `Our expertise and design process helps us minimize the number of revisions. To achieve
    this we conduct thorough discovery sessions with the lead designer and project manager to
    define the design and general product direction for future updates.
    We also bring several test-ready versions for each solution so the best one can be
    determined.
    There are cases where we suggest new features or the scope of work results to be bigger
    than was expected. In this case, we take additional time to agree on new features or to
    adjust the work scope affecting the roadmap and pushing deadlines.`,
  },
  {
  ...
  },
  {
    ...
    a: `We do not provide development but we do every other thing related to product design. Also,
    we always keep in touch with developers and make sure that the communication is friendly
    and transparent.`,
  },
  {
    ...
    <div className="w-full py-8">
      <Disclosure>
        ...
        <div className="md:hidden">
          ...
          >
            <Disclosure.Panel className="mt-8 text-body-s">
              {answer}
            </Disclosure.Panel>
          </Transition>
        </div>
