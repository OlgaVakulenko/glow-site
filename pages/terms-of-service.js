...
const sections = [
  ...
  {
    title: `Section 1 – Terms of using this site and services terms `,
    paragraphs: [
  ...
  {
    title: 'Section 3 – Accuracy, completeness and timelines of information',
    paragraphs: [
  ...
  {
    title: `Section 8 – User comments, feedback and other submissions`,
    paragraphs: [
      `As we use third parties services, we have no control over these services.
      Certain content, products and Services available via our Service may include materials from third-parties.`,
      `Third-party links on this site may direct you to third-party websites that are not affiliated with us. We are not responsible for examining or evaluating the content or accuracy and we do not warrant and will not have any liability or responsibility for any third-party materials or websites, or for any other materials, products, or Services of third-parties.`,
  ...
  {
    title: 'Section 10 – Errors, inaccuracies and omissions',
    paragraphs: [
  ...
  {
    title: `Section 12 – Disclaimer of warranties; limitation of liability`,
    paragraphs: [
  ...
  {
    title: `Section 13 – Indemnification`,
    paragraphs: [
  ...
  {
    title: `Section 18 – Changes to Terms of Service`,
    paragraphs: [
...
export default function TermsOfService() {
  return (
    <div className="pb-[150px]">
      ...
      <PolicyLayout className="grid gap-12 pt-20">
